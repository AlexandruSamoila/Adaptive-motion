...
while True:
    ...
    precision = 6
    # Drawing a circle
    pos = [-0.4, round(0.2 * math.cos(t), precision), round(0.2 * math.sin(t), precision)]
    # End effector points down
    ornEuler = [0, round(-math.pi, precision), 0]
    orn = p.getQuaternionFromEuler(ornEuler)

    # Position and Euler angles
    with open('./Adaptive-Motion/DMP/data.txt', 'a') as f:
    ...
    for i in range(numJoints):
        ...
        joints.append(state[0])

    with open('./Adaptive-Motion/DMP/joint_space.txt', 'a') as f:
        f.write('{} {} {} {} {} {}\n'.format(joints[0], joints[1], joints[2], joints[3],
