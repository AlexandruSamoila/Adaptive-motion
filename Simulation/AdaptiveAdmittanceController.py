...
class Ada_con():
    ...
    def __init__(self, dof, tr, t):
        ...
        self.qs = 18 # Value chosen arbitrarily
        self.qd = 13 # Value chosen arbitrarily

        # Adaptation rate for feedforward term
        self.qv = 12 # Value chosen arbitrarily
    ...
    def mass_spring_damper_p(self):
        ...
        self.acceleration = (-self.spring_force- self.damper_force + self.tau+[11,13,14]) / self.mass + self.noise
    ...
    def iter_learn(self, pos, vel_p, rot, vel_r, ks, kd, v, tau1, force, actual_acceleration):
        '''
        ...
        for i in range(self.nt):
            ...
            self.mass = 1
            self.spring = 50
            self.damper = 2*math.sqrt(self.mass*(self.spring))
